...
@section('pageTitle')
    {{__('app.default_add_title',["app_name" => __('app.app_name'),'Purchase data'])}}
@endsection
    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('app.edit')}} Purchase entry</li>
            </ol>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">{{trans('app.edit')}} Purchase entry</div>
                        <div class="panel-body">
                            ...
                            <form action="{{url('/purchase/update')}}" name="app_add_form" id="app_form" style="border-radius: 0px;" method="post" class="form-horizontal group-border-dashed">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="rtgs" id="rtgs" placeholder="RTGS No" class="form-control input-sm required" value="{{$details->rtgs}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="narration" id="narration" placeholder="Narration" class="form-control input-sm required" value="{{$details->narration}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="number" name="quantity" id="quantity" placeholder="Quantity" class="form-control input-sm required" value="{{$details->quantity}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="number" name="per_voucher_prize" id="per_voucher_prize" placeholder="Quantity" class="form-control input-sm required" value="{{$details->per_voucher_prize}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="number" name="total_amount" id="total_amount" placeholder="Total Amount" class="form-control input-sm required" value="{{$details->total_amount}}" />
                                    </div>
                                </div>
